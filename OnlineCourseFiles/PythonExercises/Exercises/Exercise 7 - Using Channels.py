...
# TODO -> Give a path to the PI tag cdt158 below 
response = client.get("TODO")
webId = response.json()['WebId']

# Use the WebId to create our channel uri
# TODO -> Select complete the url below to get the correct endpoint for creating a channel
channelUri = "wss://pisrv01.pischool.int/piwebapi/streams/" + webId + '/TODO'
