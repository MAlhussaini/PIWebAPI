...
# Make a GetByPath request to the Element controller
# TODO -> Enter the desired endpoint (everything after the base url) in the parentheses below
response = client.get(endpoint="TODO") 
